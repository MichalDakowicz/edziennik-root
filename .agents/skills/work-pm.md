...
- then execute the same engine as `.agents/skills/work.md`
...
| Wiki loop | Same read/write behavior as `work.md` |
...
After PM pre-flight, run `work.md` logic with these additions.
