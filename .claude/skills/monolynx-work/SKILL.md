...
- **Jesli podano ticket-id** (`$ARGUMENTS` nie jest pusty):
  Pobierz ticket: `mcp__monolynx__get_ticket(project_slug="e-dziennik", ticket_id="$ARGUMENTS")`

- **Jesli NIE podano ticket-id**:
  1. Pobierz tablice Kanban: `mcp__monolynx__get_board(project_slug="e-dziennik")`
...
```
mcp__monolynx__update_ticket(project_slug="e-dziennik", ticket_id="<ID>", status="in_progress")
```
...
mcp__monolynx__update_acceptance_criterion(project_slug="e-dziennik", ticket_id="<ID>", criterion_id="<CID>", is_completed=true)
```
...
```
mcp__monolynx__list_acceptance_criteria(project_slug="e-dziennik", ticket_id="<ID>")
```
...
```
mcp__monolynx__update_ticket(project_slug="e-dziennik", ticket_id="<ID>", status="in_review")
```
