...
```
mcp__monolynx__search_wiki(project_slug="e-dziennik", query="<glowny temat zadania>")
```
...
```
mcp__monolynx__query_graph(project_slug="e-dziennik")
mcp__monolynx__list_graph_nodes(project_slug="e-dziennik", search="<nazwa pliku/klasy/funkcji>")
```

Jesli znaleziono istotne node'y — pobierz ich sasiedztwo:

```
mcp__monolynx__get_graph_node(project_slug="e-dziennik", node_id="<id>", depth=2)
```
...
```
mcp__monolynx__search_tickets(project_slug="e-dziennik", query="<slowa kluczowe zadania>")
mcp__monolynx__list_sprints(project_slug="e-dziennik")
mcp__monolynx__list_labels(project_slug="e-dziennik")
```
