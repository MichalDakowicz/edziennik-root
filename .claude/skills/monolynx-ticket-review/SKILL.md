...
2. Dla kazdego twierdzenia wykonaj `mcp__monolynx__search_wiki(project_slug="e-dziennik", query="<twierdzenie>")`
3. Jesli wynik wymaga glebszej analizy — pobierz pelna strone: `mcp__monolynx__get_wiki_page(...)`
4. Opcjonalnie sprawdz graf: `mcp__monolynx__query_graph(project_slug="e-dziennik", search="<element>")`
